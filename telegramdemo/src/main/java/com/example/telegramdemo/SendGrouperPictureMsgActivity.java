...
public class SendGrouperPictureMsgActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sendpictureeverygrouper);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.send: {
                ...
                intent.setAction("groupPictureMsg");
